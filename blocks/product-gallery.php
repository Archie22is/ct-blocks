  ...
  <div class="product-gallery__inner">
    <?php if (!empty($gallery_image_ids)) : ?>
      <div class="product-gallery__slider js-slider" data-carousel='<?php echo json_encode($slider_args); ?>'>
        ...
        <a class="d-block w100 product-gallery__slider-item" data-fancybox="img" href="<?php echo $image_link = wp_get_attachment_url($featured_image_id); ?>" title="<?php _e('View a product image in the popup', 'namquang'); ?>">
        ...
        <?php if (!empty($gallery_image_ids)) :
          foreach ($gallery_image_ids as $gallery_image_id) :
            ...
            <a class="d-block w100 product-gallery__slider-item" data-fancybox="img" href="<?php echo $image_url; ?>" title="<?php _e('View product thumbnail', 'namquang'); ?>">
