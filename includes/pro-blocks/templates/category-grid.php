    ...
    <div class="<?php echo $container_class; ?> category-grid__container">
      <?php if (!empty($title)) : ?>
        <header class="category-grid__header">
          <h2 class="category-grid__title" data-aos="fade-up"><?php echo esc_html($title); ?></h2>
          <?php if (!empty($sub_title)) : ?>
            <div class="category-grid__sub-title" data-aos="fade-up"><?php echo esc_html($sub_title); ?></div>
          <?php endif; ?>
        </header>
      <?php endif; ?>
      <div class="category-grid__main">
        <div class="grid category-grid__grid">
          ...
          foreach ($product_categories as $category) :
            ...
            ?>
            <div class="category-grid__col" data-aos="fade-up">
            ...
            $count++;
            if (
              ($style == "style-2" && $count == 3) ||
              ($style == "style-4" && $count == 4)
            ) {
              break;
            }
            ?>
