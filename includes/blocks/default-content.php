...
class Codetot_Block_Default_Content extends Codetot_Base_Block implements Codetot_Base_Block_Interface
{
  /**
   * Singleton instance
   *
   * @var Codetot_Block_Default_Content
   */
   ...
   *
   * @return Codetot_Block_Default_Content
   */
  ...
  {
    $this->block_name = 'default-content';
