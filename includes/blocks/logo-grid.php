...
class Codetot_Block_Logo_Grid extends Codetot_Base_Block implements Codetot_Base_Block_Interface
{
  ...
  public function __construct()
  {
    ...
    $this->block_title = __('Logo Grid', 'ct-blocks');
    $this->fields = [
      // Options
      'class',
      'anchor_name',
